...
```bash
python scripts/make_release_checksums.py --zip-repo --version 2.1.8 --out dist
gh release create v2.1.8 --title "2.1.8" --target main --notes "…" dist/FTW-2.1.8-src.zip dist/SHA256SUMS
```
