...
```bash
python scripts/make_release_checksums.py --zip-repo --version 2.0.7 --out dist
gh release create v2.0.7 --title "2.0.7" --target main --notes "…" dist/FTW-2.0.7-src.zip dist/SHA256SUMS
```
