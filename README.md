...
```bash
python scripts/make_release_checksums.py --zip-repo --version 2.0.6 --out dist
gh release create v2.0.6 --title "2.0.6" --target main --notes "…" dist/FTW-2.0.6-src.zip dist/SHA256SUMS
```
