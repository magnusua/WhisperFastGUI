...
```bash
python scripts/make_release_checksums.py --zip-repo --version 2.0.4 --out dist
gh release create v2.0.4 --title "2.0.4" --target main --notes "…" dist/FTW-2.0.4-src.zip dist/SHA256SUMS
```
