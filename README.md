...
```bash
python scripts/make_release_checksums.py --zip-repo --version 2.0.5 --out dist
gh release create v2.0.5 --title "2.0.5" --target main --notes "…" dist/FTW-2.0.5-src.zip dist/SHA256SUMS
```
