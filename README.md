...
```bash
python scripts/make_release_checksums.py --zip-repo --version 2.0.8 --out dist
gh release create v2.0.8 --title "2.0.8" --target main --notes "…" dist/FTW-2.0.8-src.zip dist/SHA256SUMS
```
